...
ecp_t_block_pickup::ecp_t_block_pickup(lib::configurator &_config) :
	...
	sr_ecp_msg->message("ecp BLOCK PICKUP loaded");
}

task_base* return_created_ecp_task(lib::configurator &_config)
{
	return new common::task::ecp_t_block_pickup(_config);
}
